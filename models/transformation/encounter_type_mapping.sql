...
with claim_header as(
  ...
  select
    case
      when trim(med.revenue_center_code) in ('0450','0459') then 'emergency department'
      when left(trim(med.bill_type_code),2) = '11' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '12' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '13' then 'outpatient'
      when left(trim(med.bill_type_code),2) = '14' then 'other'
      when left(trim(med.bill_type_code),2) = '15' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '16' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '17' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '18' then 'acute inpatient'
      ...
      when left(trim(med.bill_type_code),2) = '41' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '42' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '43' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '44' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '45' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '46' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '47' then 'acute inpatient'
      when left(trim(med.bill_type_code),2) = '48' then 'acute inpatient'
      ...
      when left(trim(med.bill_type_code),2) = '84' then 'acute inpatient'
      ...
      when trim(med.place_of_service_code) = '21' then 'acute inpatient'
      when trim(med.place_of_service_code) = '22' then 'outpatient'
      when trim(med.place_of_service_code) = '23' then 'emergency department'
